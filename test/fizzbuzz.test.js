...
describe('#fizzbuzz()', () => {
  it("Return a number that is divisible by 3", () => {
    assert.equal(fizzbuzz(66), "Fizz", "A number isn't divisible by 3")
  })
  ...
  it("Return a string that is not divisible by 3 and 5", () => {
    assert.equal(fizzbuzz(7), '7', "A number is not divisible by 3 and 5")
  })
  it("Return a number that is not divisible by 3 and 5", () => {
    assert.notEqual(fizzbuzz(7), "Fizz", "A number isn't divisible by 3 and 5")
  })
})